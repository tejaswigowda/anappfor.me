!function () {
  ...
  Tree.parse = function (object, childrenAttr) {
    ...
    (function walkDown(node, parent) {
      ...
      if (!parent) {
        newNode = root = new Tree(null, getNodeData(node));
      } else {
        newNode = new Tree(parent, getNodeData(node));
  ...
  Tree.prototype.appendChild = function (data, id) {
    var child = new Tree(this, data, id);
    this.children.push(child);
    return this;
  };
  
  Tree.prototype.removeChild = function (arg) {
  ...
  Tree.prototype.traverseUp = function (iterator) {
    _traverse(this, iterator, _traverseUp);
  };
  
  Tree.prototype.traverseDown = function (iterator) {
  ...
  Tree.prototype.find = function (finder) {
    var match = null,
  ...
  Tree.prototype.path = function (path, separator) {
    separator = separator || '/';
